...
Received: from ml01.01.org (ml01.01.org [IPv6:2001:19d0:306:5::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C2483DB40C
	for <lists+linux-nfc@lfdr.de>; Fri, 30 Jul 2021 08:57:10 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 64EF9100EB85F;
	Thu, 29 Jul 2021 23:57:07 -0700 (PDT)
Received-SPF: Pass (mailfrom) identity=mailfrom; client-ip=185.125.188.121; helo=smtp-relay-canonical-1.canonical.com; envelope-from=krzysztof.kozlowski@canonical.com; receiver=<UNKNOWN> 
Received: from smtp-relay-canonical-1.canonical.com (smtp-relay-canonical-1.canonical.com [185.125.188.121])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
	(No client certificate requested)
	by ml01.01.org (Postfix) with ESMTPS id 00828100EB842
	for <linux-nfc@lists.01.org>; Thu, 29 Jul 2021 23:57:04 -0700 (PDT)
Received: from mail-ej1-f70.google.com (mail-ej1-f70.google.com [209.85.218.70])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by smtp-relay-canonical-1.canonical.com (Postfix) with ESMTPS id 9A7C23F105
	for <linux-nfc@lists.01.org>; Fri, 30 Jul 2021 06:57:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canonical.com;
	s=20210705; t=1627628223;
	bh=0kDWNx9uyxTbnlLjke2exvsU4op/n5SQk2w+sYuXuEM=;
	h=From:To:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version;
	b=
Received: by mail-ej1-f70.google.com with SMTP id a19-20020a1709063e93b0290551ea218ea2so2766492ejj.5
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=0kDWNx9uyxTbnlLjke2exvsU4op/n5SQk2w+sYuXuEM=;
        b=
X-Gm-Message-State: AOAM530aiJLDKSI0PX3ksXlm01satlOJdgdqUsjT2lF+iEC5LiKgiM/z
	VzZNqJFUB1V7ujusM55T8ujyp2vS9H7ga+T58BKydDYvkjr4nrrE55h4Rtk1FPe4lDNs+GxAN/B
	LZEwCVB3YpzuO7YooMvmTFRgOC8pnVkX50Q==
X-Received: by 2002:aa7:db94:: with SMTP id u20mr1210358edt.381.1627628223243;
...
MIME-Version: 1.0
Message-ID-Hash: F72BAZCZLWZTLGY4PVZYYETDLLDXEQA3
X-Message-ID-Hash: F72BAZCZLWZTLGY4PVZYYETDLLDXEQA3
X-MailFrom: krzysztof.kozlowski@canonical.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
X-Mailman-Version: 3.1.1
Precedence: list
Subject: [linux-nfc] [PATCH v2 6/8] nfc: nci: constify several pointers to u8, sk_buff and other structs
List-Id: NFC on Linux <linux-nfc.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nfc@lists.01.org/message/F72BAZCZLWZTLGY4PVZYYETDLLDXEQA3/>
