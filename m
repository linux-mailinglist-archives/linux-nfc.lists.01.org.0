...
Received: from ml01.01.org (ml01.01.org [IPv6:2001:19d0:306:5::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 8262D3DB40A
	for <lists+linux-nfc@lfdr.de>; Fri, 30 Jul 2021 08:57:08 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 41E46100EB856;
	Thu, 29 Jul 2021 23:57:04 -0700 (PDT)
Received-SPF: Pass (mailfrom) identity=mailfrom; client-ip=185.125.188.121; helo=smtp-relay-canonical-1.canonical.com; envelope-from=krzysztof.kozlowski@canonical.com; receiver=<UNKNOWN> 
Received: from smtp-relay-canonical-1.canonical.com (smtp-relay-canonical-1.canonical.com [185.125.188.121])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
	(No client certificate requested)
	by ml01.01.org (Postfix) with ESMTPS id 8F9D5100EB857
	for <linux-nfc@lists.01.org>; Thu, 29 Jul 2021 23:57:02 -0700 (PDT)
Received: from mail-ed1-f69.google.com (mail-ed1-f69.google.com [209.85.208.69])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by smtp-relay-canonical-1.canonical.com (Postfix) with ESMTPS id 577F33F109
	for <linux-nfc@lists.01.org>; Fri, 30 Jul 2021 06:57:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canonical.com;
	...
	b=RItneORzbFobrF69cKvXESD2VKYRFFuA2Q+lvZjoCCQqtg2ChDl8E4AJiHp2KeWHR
	 ...
	 m5URSnRWzg5Vg==
Received: by mail-ed1-f69.google.com with SMTP id l3-20020aa7c3030000b02903bccf1897f9so545624edq.19
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=uMkuh0xJL9kOCZ9QqooVEWp1gQQGTQsw+N/FjbB0TVA=;
        b=
X-Gm-Message-State: AOAM533N+ZVGNvILPWJI4423bQDTAnyIDJDOHgzT/4Ew/FZQdY8mSUcE
	S6vgPM1gwPpfXA10aPcFFNr7WoRRYyBlfjTrtT1gaqaNVRDmQBHG6PX2p2r0A0ivGiiQlbs0uf6
	Hy1Bwfh6aFM6x2oPlPMJpqnWMIZG3foIOQQ==
X-Received: by 2002:a05:6402:12c3:: with SMTP id k3mr1256101edx.11.1627628220935;
...
MIME-Version: 1.0
Message-ID-Hash: 4G72ZEO342X3L2JDV2F6NFOD2RWGLHOE
X-Message-ID-Hash: 4G72ZEO342X3L2JDV2F6NFOD2RWGLHOE
X-MailFrom: krzysztof.kozlowski@canonical.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
X-Mailman-Version: 3.1.1
Precedence: list
Subject: [linux-nfc] [PATCH v2 4/8] nfc: constify several pointers to u8, char and sk_buff
List-Id: NFC on Linux <linux-nfc.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nfc@lists.01.org/message/4G72ZEO342X3L2JDV2F6NFOD2RWGLHOE/>
